...
import 'package:outsourcing/z_supervisor/dashboard/controller/placements_controller.dart';

class ListPlacementSWidget extends StatefulWidget {
  const ListPlacementSWidget({
    Key? key,
  }) : super(key: key);

  @override
  State<ListPlacementSWidget> createState() => _ListPlacementSWidgetState();
}

class _ListPlacementSWidgetState extends State<ListPlacementSWidget> {
  var placementCon = Get.put(PlacementSController());
