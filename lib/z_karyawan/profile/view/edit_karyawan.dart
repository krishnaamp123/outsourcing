...
class EditEmployeeProfilePage extends StatefulWidget {
  ...
  @override
  EditEmployeeProfilePageState createState() => EditEmployeeProfilePageState();
}

class EditEmployeeProfilePageState extends State<EditEmployeeProfilePage> {
  var animate = false;
  var opacity = 0.0;
  bool position = false;
  late Size size;
  ...
  Future<void> _updateProfile(BuildContext context) async {
    try {
      final response = await employee.patchEmployee(
        widget.id,
      ...
      if (response.statusCode == 200) {
        ...
        if (userData != null) {
          ...
          await localStorage.setString('karyawan', jsonEncode(user));
        }
