...
import 'package:outsourcing/z_karyawan/profile/controller/employee_controller.dart';
...
class ProfileEmployeePage extends StatefulWidget {
  ...
  @override
  State<ProfileEmployeePage> createState() => ProfileEmployeePageState();
}

class ProfileEmployeePageState extends State<ProfileEmployeePage> {
  var employeeCon = Get.put(EmployeeController());
  ...
  Widget buildImageWithCookie(int id) {
    return FutureBuilder<Uint8List>(
      future: employeeCon.employee.fetchImageWithCookie(id),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: RefreshIndicator(
        ...
        child: isDataLoaded
            ? Obx(() => employeeCon.isLoading.value
                ? const Center(
                ...
                : SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: employeeCon.listEmployee.map((placementuser) {
                        var user = placementuser;
                        var userprofile = placementuser.employeeProfile;
